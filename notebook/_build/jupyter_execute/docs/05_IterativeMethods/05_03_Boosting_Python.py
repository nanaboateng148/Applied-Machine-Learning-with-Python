...
get_ipython().run_line_magic('time', '_, p, _ = solvers.gauss_seidel(p, b, dx, tol, max_it)')


# In[21]:


get_ipython().run_line_magic('time', '_, nb_p, _ = solvers.gauss_seidel(nb_p, b, dx, tol, max_it, use_numba=True)')


# In[22]:


get_ipython().run_line_magic('time', '_, c_p, _ = csolver.c_gauss_seidel(c_p, b, dx, tol, max_it)')
